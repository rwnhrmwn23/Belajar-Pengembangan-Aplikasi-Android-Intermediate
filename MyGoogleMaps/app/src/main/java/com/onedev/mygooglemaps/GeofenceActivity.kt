...
import com.onedev.mygooglemaps.databinding.ActivityGeofenceBinding
...
class GeofenceActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val centerLat = -6.2772542
    private val centerLng = 106.9738664
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(MarkerOptions().position(stanford).title("KodeV Academy"))
            ...
            addOnCompleteListener {
                geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent).run {
                    ...
                    addOnFailureListener {
                        showToast("Geofenceing not added : ${it.message}")
                    }
                }
            }
        }
