package com.onedev.storyapp.ui.widget
...
class StoryWidget : AppWidgetProvider() {
    companion object {
        private const val TOAST_ACTION = "com.onedev.storyapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.onedev.storyapp.EXTRA_ITEM"
